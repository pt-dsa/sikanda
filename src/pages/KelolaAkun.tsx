                ...
                <table className="w-full text-sm text-left border-collapse relative">
                  <thead className="sticky top-0 z-10 bg-gray-50/95 dark:bg-gray-800/95 backdrop-blur-sm">
                    <tr className="text-xs uppercase tracking-wider text-gray-500 dark:text-gray-400 border-b border-gray-200 dark:border-gray-700">
                      <th className="px-4 py-3 font-extrabold w-[200px]">Nama Pegawai</th>
                      <th className="px-4 py-3 font-extrabold w-[160px]">NIP</th>
                      <th className="px-4 py-3 font-extrabold w-[140px]">Status Pegawai</th>
                      <th className="px-4 py-3 font-extrabold w-[180px]">Jabatan</th>
                      <th className="px-4 py-3 font-extrabold w-[200px]">Email</th>
                      <th className="px-4 py-3 font-extrabold w-[120px]">Peran</th>
                      <th className="px-4 py-3 font-extrabold w-[140px]">Status</th>
                      <th className="px-4 py-3 font-extrabold text-right w-[140px]">Aksi</th>
                    </tr>
                  </thead>
                  <tbody>
                    {filteredUsers.map((u) => {
                      const emp = pegawai.find((p) => p.nip === u.nip);
                      return (
                      <tr key={u.email} className="border-b border-gray-50 dark:border-gray-800/50 hover:bg-gray-50/50 dark:hover:bg-gray-800/30">
                        ...
                        <td className="px-4 py-3 text-gray-600 dark:text-gray-300 font-medium text-xs">{emp ? employmentStatusLabel(emp) : "—"}</td>
                        <td className="px-4 py-3 text-gray-600 dark:text-gray-300 font-medium text-xs">{emp?.jabatan || "—"}</td>
