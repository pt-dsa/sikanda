  ...
  return (
    <div className="fixed bottom-4 right-4 z-50 flex flex-col gap-2 p-4 bg-white rounded-lg shadow-xl border border-gray-200 w-80 max-w-[calc(100vw-2rem)]">
      ...
      <p className="text-sm text-gray-600 mb-2">
        {offlineReady
          ? 'SIKANDA kini dapat diakses secara offline dan memuat lebih cepat.'
          : 'Versi terbaru SIKANDA telah dirilis. Silakan muat ulang untuk mengaplikasikan pembaruan.'}
      </p>
      {needRefresh && (
        <button
